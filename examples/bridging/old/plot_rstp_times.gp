...
plot data using xCol:16  with linespoints t 'Alg. init' lt rgb "blue",\
     ...
     data using xCol:29  with linespoints t 'Alg. fail (MAexp)' lt rgb "red",\
     data using xCol:30 with linespoints t 'Prot. fail (MAexp)' lt rgb "red",\
     data using xCol:31  with linespoints t 'Alg. fail' lt rgb "green",\
     data using xCol:32 with linespoints t 'Prot. fail' lt rgb "green"

...
set output data."_counters_init.png"
...
plot data using xCol:6  with linespoints t 'Number of Ports',\
     data using xCol:8  with linespoints t 'Send',\
     data using xCol:9 with linespoints t 'Hold',\
     data using xCol:10 with linespoints t 'Rcvd',\
     data using xCol:11 with linespoints t 'Rcvd_Better_Des',\
     data using xCol:12 with linespoints t 'Rcvd_Worse_Des',\
     data using xCol:13 with linespoints t 'Rcvd_Equal_Des',\
     data using xCol:14 with linespoints t 'Rcvd_Worse_R-A',\
     data using xCol:15 with linespoints t 'Rcvd_Equal_R-A'

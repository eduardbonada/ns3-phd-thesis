...
#ifndef ETH_POINT_TO_POINT_NET_DEVICE_H
#define ETH_POINT_TO_POINT_NET_DEVICE_H
 ...
 * \brief A Device for a Point to Point Ethernet Network Link. Using PoinToPointNetDevice ans CsmaNetDevices as references.
 *
 * This EthPointToPointNetDevice class specializes the NetDevice abstract
 * base class.  Together with an EthPointToPointChannel (and a peer 
 * EthPointToPointNetDevice), the class models, with some level of 
 * abstraction, a generic point-to-point link.  
 * Key parameters or objects that can be specified for this device 
 * include a queue, data rate, and interframe transmission gap (the 
 * propagation delay is set in the EthPointToPointChannel).
 */
class EthPointToPointNetDevice : public NetDevice 
{
public:
  ...
  /**
   * Construct a EthPointToPointNetDevice
   *
   * This is the constructor for the EthPointToPointNetDevice.
   */
  EthPointToPointNetDevice ();

  /**
   * Destroy a EthPointToPointNetDevice
   *
   * This is the destructor for the EthPointToPointNetDevice.
   */
  virtual ~EthPointToPointNetDevice ();
   ...
   */
  bool Attach (Ptr<EthPointToPointChannel> ch);

  /**
   * Attach a queue to the EthPointToPointNetDevice.
   *
   * The EthPointToPointNetDevice "owns" a queue that implements a queueing 
  ...
  /**
   * Attach a receive ErrorModel to the EthPointToPointNetDevice.
   *
   * The EthPointToPointNetDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected EthPointToPointChannel.
   *
   * The EthPointToPointNetDevice receives packets from its connected channel
   * and forwards them up the protocol stack.  This is the public method
   * used by the channel to indicate that the last bit of a packet has 
   * arrived at the device.
   *
   * /see EthPointToPointChannel
   ...
   * \see SetFrameSize
   */
  void SetEncapsulationMode (EthPointToPointNetDevice::EncapsulationMode mode);
   ...
   */
  EthPointToPointNetDevice::EncapsulationMode  GetEncapsulationMode (void);
...
private:
   ...
   * \return a copy of the removed header
   */
  EthernetHeader ProcessHeader(Ptr<Packet> p, uint16_t& param);

  /**
   * Start Sending a Packet Down the Wire.
   *
   * The TransmitStart method is the method that is used internally in the
   * EthPointToPointNetDevice to begin the process of sending a packet out on
   * the channel.  The corresponding method is called on the channel to let
   * it know that the physical device this class represents has virually
   * started sending signals.  An event is scheduled for the time at which
   * the bits have been completely transmitted.
   *
   * \see EthPointToPointChannel::TransmitStart ()
  ...
  /**
   * The EthPointToPointChannel to which this EthPointToPointNetDevice has been
   * attached.
   * \see class EthPointToPointChannel
   */
  Ptr<EthPointToPointChannel> m_channel;

  /**
   * The Queue which this EthPointToPointNetDevice uses as a packet source.
   * Management of this Queue has been delegated to the EthPointToPointNetDevice
...
#endif // ETH_POINT_TO_POINT_NET_DEVICE_H

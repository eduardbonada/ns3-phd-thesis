                      ...
                      if(m_neighId.size()==m_numNeighbors)
                        {
                          ...
                          m_iAmNeighbor=false;
                          m_numNeighbors=m_portInfo.size ();
                          NS_LOG_INFO("Bridge " << m_bridgeInfo.bridgeId << " sets the number of neighbors to " << m_numNeighbors );
                          m_rdRcvdFromNeigh.resize(0);
                          m_rdRcvdInPort.resize(0);
                          m_neighId.resize(0);
                              ...
                              if(m_portInfo[i].state!=DISABLED_STATE)
                                {
                                  ...
                                  m_portInfo[i].messAgeTimer.Remove();
                                }                        
                            }
              ...
              if(bpduUpdates == 1 && bpdu.GetRoleFlags()==DESIGNATED_ROLE)
                {
                  ...
                  if(m_activateRootFailureConf==1 && m_portInfo[inPort].designatedRootId==minRootId)
                    {

...
#ifndef _BPDU_HEADER_CONF_H
#define _BPDU_HEADER_CONF_H
...
class BpduConfHeader : public Header 
{
public:
  ...
  uint16_t GetNumNeighbors (void);
  void     SetNumNeighbors (uint16_t n);

  // BPDU wiht confirmation

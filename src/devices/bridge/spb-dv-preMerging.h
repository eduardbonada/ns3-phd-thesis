...
private:
  ...
  int16_t UpdatesInfo(BpduHeader bpduHdr, uint16_t port, uint64_t tree);

  int16_t BetterPathVector(bool bpduRcvd, BpduHeader bpduHdr, uint16_t portA, uint16_t portB, uint64_t tree);

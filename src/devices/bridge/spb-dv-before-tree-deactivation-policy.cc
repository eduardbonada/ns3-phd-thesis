  ...
  if(returnValue==2)  
    {
      ...
      if(bpduHdr.GetBridgeId(bpduInd) == m_portInfo[port].designatedBridgeId.at(tree) &&  bpduHdr.GetPortId(bpduInd) == m_portInfo[port].designatedPortId.at(tree) && m_portInfo[port].designatedBridgeId.at(tree)!=m_bridgeInfo.bridgeId )
        {
